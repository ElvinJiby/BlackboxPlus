...
public class Node {
    ...
    private Node[] sides;//the next nodes on each side of the hexagon
    private boolean isexit;//set to true if the node is a exit node
    ...
    public boolean isexit(){
        return this.isexit;
    }//checks if the node is a exit node or not.
